return {
	{
		...
		opts = {
			...
			colors = {
				...
				base01 = "{{color0}}", -- Lighter background (status bars)
				base02 = "{{color7}}", -- Selection background
				base03 = "{{color1}}", -- Comments, invisibles
				...
				base08 = "{{color14}}", -- Variables, errors, red
				base09 = "{{color15}}", -- Integers, constants, orange
				base0A = "{{color3}}", -- Classes, types, yellow
				base0B = "{{color3}}", -- Strings, green
